import cv2
cap = cv2.VideoCapture(r"D:\ai-playground\videos\demo.mp4")

NumberPlateCascade=cv2.CascadeClassifier(r"D:\ai-playground\haarcascades\haarcascade_russian_plate_number.xml")
